...
#define STR_M115_REPORT                     "FIRMWARE_NAME:Marlin FIRMWARE_VERSION:" SHORT_BUILD_VERSION " HARDWARE_VERSION:" HARDWARE_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) 
...
// perron
#include "../wtdgus/language_multi.h"
